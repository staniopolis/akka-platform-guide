...
public final class PublishEventsProjection {
    ...
    public static void init(ActorSystem<?> system, Supplier<HibernateJdbcSession> sessionSupplier) {
                ...
                .init(
                        ...
                        index ->
                                ProjectionBehavior.create(
                                        createProjectionFor(system, topic, sendProducer, index, sessionSupplier)),
    ...
    createProjectionFor(
            ...
            int index
            , Supplier<HibernateJdbcSession> sessionSupplier
    ) {
